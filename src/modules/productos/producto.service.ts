...
export class ProductoresService {
  ...
  async crearDesdeUsuario(
    usuario: Usuario,
    dto: { cedula?: string; telefono?: string; finca?: string; ubicacion?: string },
  ): Promise<Productor> {
  ...
  async crear(dto: CrearProductorDto): Promise<Productor> {
    ...
    async desactivar(id: number): Promise<{ mensaje: string; productor: Productor }> {
    ...
    async activar(id: number): Promise<{ mensaje: string; productor: Productor }> {
    ...
    private async _verificarCedulaUnica(cedula: string, excludeId?: number): Promise<void> {
